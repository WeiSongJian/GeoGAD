...
python data/split.py \
    ...
    --filter 111
# process
python -m data.dataset  --dataset ${DATA_DIR}/skempi_all.json
python -m data.dataset  --dataset ${DATA_DIR}/valid.json
python -m data.dataset  --dataset ${DATA_DIR}/train.json
