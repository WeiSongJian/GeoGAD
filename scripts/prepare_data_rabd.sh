...
do
    ...
    python data/split.py \
        ...
        --filter 111
    # process
    python -m data.dataset --dataset ${PROCESS_DIR}/test.json
    python -m data.dataset --dataset ${PROCESS_DIR}/valid.json
    python -m data.dataset --dataset ${PROCESS_DIR}/train.json
done
